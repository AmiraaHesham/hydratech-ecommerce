    ...
    <div className="bg-[#F9FAFB]">
      <div className="w-full h-10  flex justify-between text-center md:text-base xs:text-sm shadow-md shadow-gray-300 mb-5 text-gray-600">
        <a
          ...
          className="flex justify-center items-center border-l border-b-2  gap-2 w-full  font-bold hover:bg-white hover:border-b-2 hover:border-b-blue-600 cursor-pointer"
        >
          <span className="bg-blue-700 text-white rounded-full text-lg p-1">
            <BiCategory />
          </span>
          {t("categories")}
        </a>
        <a
          ...
          className="flex justify-center items-center gap-2  w-full  border-b-2  font-bold hover:bg-white  hover:border-b-2 hover:border-b-blue-600 cursor-pointer"
        >
          <span className="bg-blue-700 text-white rounded-full text-sm p-1">
        ...
        <a
          href="#footer"
          className="flex justify-center items-center  border-b-2 border-r gap-2 w-full  font-bold hover:bg-white  hover:border-b-2 hover:border-b-blue-600 cursor-pointer"
        >
          <span className="bg-blue-700 text-white rounded-full text-lg p-1">
            <MdContactSupport />
          </span>
      ...
      <section id="FeatuerProducts" className="h-[700px]">
        {loading ? (
